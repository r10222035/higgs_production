...
\label{sec:particle_transformer}
    ...
    \label{sub:cwola_training_with_part}
        ...
        The comparison between the two scenarios is shown in figure~\ref{fig:ParT_AUC_various_L}. The training performance is very unstable on both cases. There are some training is totaly failed.
        \begin{figure}[htpb]
            \centering
    ...
    \label{sub:phi_shifting_augmentation_on_part}
        ...
        \begin{table}[htpb]
            ...
            \end{tabular}
        \end{table}
        The results show that $\phi$-shifting augmentation improves model performance. The $\phi$-shifting augmentation helps improve generalization, but can not mitigate the statistical flunctuation.
    % subsection phi_shifting_augmentation_on_part (end)
    \subsection{Implement \texorpdfstring{$p_{\mathrm{T}}$}{pT} normalization with ParT}% (fold)
    \label{sub:implement_pt_normalization_with_part}
        ...
        The comparison between the two scenarios is shown in figure~\ref{fig:ParT_AUC_various_L_pTnorm}. The training performance is still unstable on both cases. There are some training is totaly failed.
        \begin{figure}[htpb]
            \centering
