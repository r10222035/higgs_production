...
\label{sec:event_cnn}
    ...
    \label{sub:h_to_zz_to_4l_channel}
        ...
        \begin{table}[htpb]
            \centering
            \caption{Event-CNN training results using datasets corresponding to different luminosities. The $ZZ \to 4\ell$ decay channel is considered, with decay product information included. ACC and AUC are averaged over 10 training runs.}
        ...
        \begin{table}[htpb]
            ...
            \end{tabular}
        \end{table}
        The performance is worse by 10\% for pure events when lepton information is removed, indicating that some of the discriminative features are removed.
