...
\label{sec:larger_training_dataset}
    ...
    \end{itemize}
    Increasing the size of the training dataset may help mitigate these effects, allowing the network to eventually learn both photon and jet patterns effectively.
