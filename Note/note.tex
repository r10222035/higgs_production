...
\label{sec:event_cnn}
    ...
    \subsection{Larger training set with event-CNN}% (fold)
    \label{sub:larger_training_set_with_event_cnn}
        ...
        \begin{table}[htpb]
            ...
            \end{tabular}
        \end{table}
        The performance improved with increased dataset size in the $M_1 / M_2$ scenario. However, for the pure datasets, the training performance is almost the same.
    % subsection larger_training_set_with_event_cnn (end)
