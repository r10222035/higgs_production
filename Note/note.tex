...
\label{sec:particle_transformer}
    ...
    \label{sub:supervised_training_with_part}
		...
		Table~\ref{tab:supervised_ParT_training_results_diphoton} summarizes the classification performance.
        \begin{table}[htpb]
            \centering
            \caption{ParT classification results.}
            \label{tab:supervised_ParT_training_results_diphoton}
            \begin{tabular}{c|c}
				 ACC               & AUC               \\ \hline
				 $0.810 $ & $0.888$ \\
			\end{tabular}
        \end{table}
		Compared to the previous results shown in table~\ref{tab:supervised_event_CNN_training_results_diphoton}, the ParT achieves slightly better performance.
