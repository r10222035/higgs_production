...
\label{sec:higgs_production}
    We want to apply the deep learning methods in distinguishing vector boson fusion (VBF) from gluon-gluon fusion (GGF) Higgs production at the LHC.
...
\label{sec:sample_preparation}
    ...
    \label{sub:monte_carlo_samples}
        ...
        The following \verb|MadGraph| scripts are used to generate Monte Carlo samples for each production channel.
